...
void ResultScene::Init(void) {
	...
	objectmanager.GetGameObjectPtr<GameObject>(UI, "CLEAR").lock()->Init(L"Game/Asset/UI/CLEAR.png");
	objectmanager.GetGameObjectPtr<GameObject>(UI, "CLEAR").lock()->SetPosition(Vector3(0.0f, 300.0f, 0.0f));
	objectmanager.GetGameObjectPtr<GameObject>(UI, "CLEAR").lock()->SetScale(Vector3(800.0f, 600.0f, 0.0f));
